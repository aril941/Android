package com.example.buktipembayaran;
...
public class StatusActivity extends AppCompatActivity {
        ...
        btnsimpan.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                if (selected_photo != null) {
                    ...
                    Toast.makeText(getApplicationContext(), "Upload bukti
                            pembayaran terlebih dahulu", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    private void loadJson() {
        ...
        StringRequest sendData = new StringRequest(Request.Method.POST,
                ServerAPI.URL_DASHBOARD_JUAL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    total.setText("Rp. " +
                            decimalFormat.format(data.getInt("total_biaya")));
    ...
    private void simpanData() {
        ...
        try {
            Bitmap bitmap =
                    ImageLoader.init().from(selected_photo).requestSize(1024,
                            1024).getBitmap();
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(StatusActivity.this, "pesan : Gagal

                                    Kirim Data", Toast.LENGTH_SHORT).show();
                        }
                    }) {
                @Override
                protected Map<String, String> getParams() {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == TAG_GALLERY) {
                ...
                try {
                    ...
                    bitmap = ImageLoader.init().from(path).requestSize(512,
                    ...
                    Snackbar.make(findViewById(android.R.id.content),
                            ...
                            "Success Loader Image", Snackbar.LENGTH_SHORT).show();
                } catch (FileNotFoundException e) {
                    e.printStackTrace();

                    Snackbar.make(findViewById(android.R.id.content),

                            "Something Wrong", Snackbar.LENGTH_SHORT).show();
                }
            }
        }
    }
    public void createPDF() {
        ...
        String outPath = FileUtils.getAppPath(getApplicationContext()) +
                "/" + format + ".pdf";
        try {
 ...
 */
            ...
            Font mTitleFont = new Font(urName, 36.0f, Font.NORMAL,
                    BaseColor.BLACK);
            Font mHeadingFont = new Font(urName, mHeadingFontSize,
                    Font.NORMAL, mColorAccent);
            Font mValueFont = new Font(urName, mValueFontSize, Font.NORMAL,
                    BaseColor.BLACK);
// LINE SEPARATOR
...
// Akun
            ...
            Chunk mAcNameValueChunk = new
                    Chunk(username.getText().toString(), mValueFont);
            Paragraph mAcNameValueParagraph = new
                    Paragraph(mAcNameValueChunk);
...
// Total
            ...
            Chunk mAmountValueChunk = new Chunk(total.getText().toString(),
                    mValueFont);
            Paragraph mAmountValueParagraph = new
                    Paragraph(mAmountValueChunk);
...
// Pembayaran
            ...
            Chunk mCashValueChunk = new Chunk("Rp. " +
                    decimalFormat.format(bayar), mValueFont);
...
// Kembalian
            ...
            Chunk mChangeValueChunk = new Chunk("Rp. " +
                    decimalFormat.format(kembali), mValueFont);
            Paragraph mChangeValueParagraph = new
                    Paragraph(mChangeValueChunk);
